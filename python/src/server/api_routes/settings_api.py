...
async def database_metrics():
    ...
    try:
        ...
        projects_response = await (
            backend.table("archon_projects").select("id", count="exact").execute()
        )
        ...
        # Get tasks count
        tasks_response = await backend.table("archon_tasks").select("id", count="exact").execute()
        ...
        pages_response = await (
            backend.table("archon_crawled_pages").select("id", count="exact").execute()
        )
        ...
        # Get settings count
        settings_response = await (
            backend.table("archon_settings").select("id", count="exact").execute()
        )
